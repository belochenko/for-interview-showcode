...
class AdapterMongo:
    ...
    def flush_result(self, category, title, url, company=None, location=None, requirements=None, additional_skills=None,
                     duty=None, language=None):
        """
        ...
        @param requirements: scrapped date of vacancy posting
        ...
        doc_to_insert = {'category': category,
                         'title': title,
                         'company': company,
                         'location': location,
...
class AdapterCSV:
    def __init__(self, filename=None):
        self.result_fieldnames = ['category', 'title', 'company', 'location', 'requirements', 'additional_skills',
                                  'duty', 'language', 'url']
    ...
    def create_csv_headline(self, filename, fieldnames):
        if not os.path.isfile(filename):
            with open(filename, mode='a+', encoding="utf-8-sig") as csv_file:
    ...
    def flush_result(self, category, title, url, company=None, location=None, requirements=None, additional_skills=None,
        ...
        with open(self.result_filename, mode='a+', encoding="utf-8-sig") as csv_file:
            ...
            writer.writerow({'category': category, 'title': title, 'company': company,
                             'location': location, 'requirements': requirements, 'additional_skills': additional_skills,
                             'duty': duty, 'language': language, 'url': url})
    ...
    def temp_store_category_links(self, links: List[str], categories_names: List[str]):
        ...
        # with open(self.temp_category_filename, mode='a+', encoding="utf-8-sig") as csv_file:
    ...
    def temp_store_vacancy_links(self, links: List[str], vacancy_titles: List[str], category_name: str):
        ...
        # with open(self.temp_vacancy_filename, mode='a+', encoding="utf-8-sig") as csv_file:
    ...
    def load_category_links(self):
        ...
        with open(self.temp_category_filename, "r", encoding="utf-8-sig") as csv_file:
    ...
    def load_categories_to_parse(self):
        ...
        with open(self.temp_vacancy_filename, "r", encoding="utf-8-sig") as csv_file:
            reader = csv.DictReader(csv_file)
            for row in reader:
    ...
    def update_vacancy_scrap_status(self, vacancy_link, vacancy_title, category):
        ...
        with open(self.temp_vacancy_filename, 'r', encoding="utf-8-sig") as csv_file, temp_file:
            ...
            for row in reader:
                if row['link'] == vacancy_link and row['vacancy_title'] == vacancy_title and row[
                    'category'] == category:
    ...
    def update_category_scrap_status(self, category):
        ...
        with open(self.temp_category_filename, 'r', encoding="utf-8-sig") as csv_file, temp_file:
